...
/**
 * BladeOne - A BladeOne Template implementation in a single file
 *
 * @package   BladeOne
...
class BladeOne
{
    ...
    /**
     * Compile the given BladeOne template contents.
     *
     * @param string $value
     * @return string
     */
    ...
    /**
     * Register a custom BladeOne compiler.
     *
    ...
    /**
     * Compile BladeOne comments into valid PHP.
     *
     * @param string $value
     * @return string
     */
    ...
    /**
     * Compile BladeOne echos into valid PHP.
     *
     * @param string $value
     * @return string
     */
    ...
    /**
     * Compile BladeOne statements that start with "@".
     *
     * @param string $value
     *
